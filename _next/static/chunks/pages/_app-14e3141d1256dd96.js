 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nn(){try{await B()}catch(e){return!1}return"undefined"!=typeof window&&N()&&"undefined"!=typeof navigator&&!!navigator.cookieEnabled&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}em(new H("messaging",ne,"PUBLIC")),em(new H("messaging-internal",nt,"PRIVATE")),eI(t7,t9),eI(t7,t9,"esm2017");let nr={apiKey:"AIzaSyAkfHBzGYQcUZL0S76E3TukmzFuzCidge4",authDomain:"koolyard-84a4a.firebaseapp.com",projectId:"koolyard-84a4a",storageBucket:"koolyard-84a4a.appspot.com",messagingSenderId:"669707854180",appId:"1:669707854180:web:8a5e8aa2dd09025df95a71",measurementId:"G-PG9PCKGMHY"},na=async e=>{console.log("Initialize Firebase Cloud Messaging");try{s=/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e=function(e=ef){let t=eh.get(e);if(!t&&e===ef&&A())return ew();if(!t)throw eb.create("no-app",{appName:e});return t}()){return nn().then(e=>{if(!e)throw tH.create("unsupported-browser")},e=>{throw tH.create("indexed-db-unsupported")}),ev($(e),"messaging").getImmediate()}(e);let t=await eB.tO.getItem("fcm_token");if(null!==t)return t;let n=await Notification.requestPermission();if(n&&"granted"===n){let e=await s.getToken({vapidKey:"BKsc3xU_8UlCKISztvYhJHM94W0aJfqVB2DqSgXUCkKAf42PT-t4UGBam2UbT7xTLojKwagmZncErhko2TTz49c"});if(e)return eB.tO.setItem("fcm_token",e),e}}catch(e){console.log("An error occurred while retrieving token. ",e)}},ni=()=>new Promise(e=>{var t,n;t=s,n=t=>{console.log("Message received. ",t),e(t)},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
