 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ey(e){let t=new Uint8Array(e),n=btoa(String.fromCharCode(...t));return n.replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}(o=c||(c={}))[o.DATA_MESSAGE=1]="DATA_MESSAGE",o[o.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION",(s=l||(l={})).PUSH_RECEIVED="push-received",s.NOTIFICATION_CLICKED="notification-clicked";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ev="fcm_token_details_db",eI="fcm_token_object_Store";async function eS(e){if("databases"in indexedDB){let e=await indexedDB.databases(),t=e.map(e=>e.name);if(!t.includes(ev))return null}let t=null,n=await S(ev,5,{upgrade:async(n,r,i,a)=>{var o;if(r<2||!n.objectStoreNames.contains(eI))return;let s=a.objectStore(eI),c=await s.index("fcmSenderId").get(e);if(await s.clear(),c){if(2===r){if(!c.auth||!c.p256dh||!c.endpoint)return;t={token:c.fcmToken,createTime:null!==(o=c.createTime)&&void 0!==o?o:Date.now(),subscriptionOptions:{auth:c.auth,p256dh:c.p256dh,endpoint:c.endpoint,swScope:c.swScope,vapidKey:"string"==typeof c.vapidKey?c.vapidKey:ey(c.vapidKey)}}}else 3===r?t={token:c.fcmToken,createTime:c.createTime,subscriptionOptions:{auth:ey(c.auth),p256dh:ey(c.p256dh),endpoint:c.endpoint,swScope:c.swScope,vapidKey:ey(c.vapidKey)}}:4===r&&(t={token:c.fcmToken,createTime:c.createTime,subscriptionOptions:{auth:ey(c.auth),p256dh:ey(c.p256dh),endpoint:c.endpoint,swScope:c.swScope,vapidKey:ey(c.vapidKey)}})}}});return n.close(),await E(ev),await E("fcm_vapid_details_db"),await E("undefined"),!function(e){if(!e||!e.subscriptionOptions)return!1;let{subscriptionOptions:t}=e;return"number"==typeof e.createTime&&e.createTime>0&&"string"==typeof e.token&&e.token.length>0&&"string"==typeof t.auth&&t.auth.length>0&&"string"==typeof t.p256dh&&t.p256dh.length>0&&"string"==typeof t.endpoint&&t.endpoint.length>0&&"string"==typeof t.swScope&&t.swScope.length>0&&"string"==typeof t.vapidKey&&t.vapidKey.length>0}(t)?null:t}let eE="firebase-messaging-store",e_=null;function eD(){return e_||(e_=S("firebase-messaging-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(eE)}})),e_}async function eC(e){let t=function({appConfig:e}){return e.appId}(e),n=await eD(),r=await n.transaction(eE).objectStore(eE).get(t);if(r)return r;{let t=await eS(e.appConfig.senderId);if(t)return await eT(e,t),t}}async function eT(e,t){let n=function({appConfig:e}){return e.appId}(e),r=await eD(),i=r.transaction(eE,"readwrite");return await i.objectStore(eE).put(t,n),await i.done,t}async function ek(e){let t=function({appConfig:e}){return e.appId}(e),n=await eD(),r=n.transaction(eE,"readwrite");await r.objectStore(eE).delete(t),await r.done}let eA=new f.LL("messaging","Messaging",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"only-available-in-window":"This method is available in a Window context.","only-available-in-sw":"This method is available in a service worker context.","permission-default":"The notification permission was not granted and dismissed instead.","permission-blocked":"The notification permission was not granted and blocked instead.","unsupported-browser":"This browser doesn't support the API's required to use the Firebase SDK.","indexed-db-unsupported":"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)","failed-service-worker-registration":"We are unable to register the default service worker. {$browserErrorMessage}","token-subscribe-failed":"A problem occurred while subscribing the user to FCM: {$errorInfo}","token-subscribe-no-token":"FCM returned no token when subscribing the user to push.","token-unsubscribe-failed":"A problem occurred while unsubscribing the user from FCM: {$errorInfo}","token-update-failed":"A problem occurred while updating the user from FCM: {$errorInfo}","token-update-no-token":"FCM returned no token when updating the user to push.","use-sw-after-get-token":"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.","invalid-sw-registration":"The input to useServiceWorker() must be a ServiceWorkerRegistration.","invalid-bg-handler":"The input to setBackgroundMessageHandler() must be a function.","invalid-vapid-key":"The public VAPID key must be a string.","use-vapid-key-after-get-token":"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."});/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eO(e,t){let n;let r=await eM(e),i=ej(t),a={method:"POST",headers:r,body:JSON.stringify(i)};try{let t=await fetch(eN(e.appConfig),a);n=await t.json()}catch(e){throw eA.create("token-subscribe-failed",{errorInfo:null==e?void 0:e.toString()})}if(n.error){let e=n.error.message;throw eA.create("token-subscribe-failed",{errorInfo:e})}if(!n.token)throw eA.create("token-subscribe-no-token");return n.token}async function eL(e,t){let n;let r=await eM(e),i=ej(t.subscriptionOptions),a={method:"PATCH",headers:r,body:JSON.stringify(i)};try{let r=await fetch(`${eN(e.appConfig)}/${t.token}`,a);n=await r.json()}catch(e){throw eA.create("token-update-failed",{errorInfo:null==e?void 0:e.toString()})}if(n.error){let e=n.error.message;throw eA.create("token-update-failed",{errorInfo:e})}if(!n.token)throw eA.create("token-update-no-token");return n.token}async function eB(e,t){let n=await eM(e);try{let r=await fetch(`${eN(e.appConfig)}/${t}`,{method:"DELETE",headers:n}),i=await r.json();if(i.error){let e=i.error.message;throw eA.create("token-unsubscribe-failed",{errorInfo:e})}}catch(e){throw eA.create("token-unsubscribe-failed",{errorInfo:null==e?void 0:e.toString()})}}function eN({projectId:e}){return`https://fcmregistrations.googleapis.com/v1/projects/${e}/registrations`}async function eM({appConfig:e,installations:t}){let n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function ej({p256dh:e,auth:t,endpoint:n,vapidKey:r}){let i={web:{endpoint:n,auth:t,p256dh:e}};return r!==eb&&(i.web.applicationPubKey=r),i}async function eP(e){let t=await ex(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:ey(t.getKey("auth")),p256dh:ey(t.getKey("p256dh"))},r=await eC(e.firebaseDependencies);if(!r)return e$(e.firebaseDependencies,n);if(function(e,t){let n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,i=t.auth===e.auth,a=t.p256dh===e.p256dh;return n&&r&&i&&a}(r.subscriptionOptions,n))return Date.now()>=r.createTime+6048e5?eH(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await eB(e.firebaseDependencies,r.token)}catch(e){console.warn(e)}return e$(e.firebaseDependencies,n)}async function eR(e){let t=await eC(e.firebaseDependencies);t&&(await eB(e.firebaseDependencies,t.token),await ek(e.firebaseDependencies));let n=await e.swRegistration.pushManager.getSubscription();return!n||n.unsubscribe()}async function eH(e,t){try{let n=await eL(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await eT(e.firebaseDependencies,r),n}catch(t){throw await eR(e),t}}async function e$(e,t){let n=await eO(e,t),r={token:n,createTime:Date.now(),subscriptionOptions:t};return await eT(e,r),r.token}async function ex(e,t){let n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:function(e){let t="=".repeat((4-e.length%4)%4),n=(e+t).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),i=new Uint8Array(r.length);for(let e=0;e<r.length;++e)i[e]=r.charCodeAt(e);return i}(t)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eq(e,t){if(t||e.swRegistration||await eU(e),t||!e.swRegistration){if(!(t instanceof ServiceWorkerRegistration))throw eA.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ez(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=eb)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eG(e,t){if(!navigator)throw eA.create("only-available-in-window");if("default"===Notification.permission&&await Notification.requestPermission(),"granted"!==Notification.permission)throw eA.create("permission-blocked");return await ez(e,null==t?void 0:t.vapidKey),await eq(e,null==t?void 0:t.serviceWorkerRegistration),eP(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eX(e,t){let n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===l.PUSH_RECEIVED&&("function"==typeof e.onMessageHandler?e.onMessageHandler(eF(n)):e.onMessageHandler.next(eF(n)));let r=n.data;"object"==typeof r&&r&&ew in r&&"1"===r["google.c.a.e"]&&await eZ(e,n.messageType,r)}let eJ="@firebase/messaging",eY="0.12.4",eQ=e=>{let t=new eW(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",e=>eX(t,e)),t},e0=e=>{let t=e.getProvider("messaging").getImmediate();return{getToken:e=>eG(t,e)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e2(e=(0,u.Mq)()){return e1().then(e=>{if(!e)throw eA.create("unsupported-browser")},e=>{throw eA.create("indexed-db-unsupported")}),(0,u.qX)((0,f.m9)(e),"messaging").getImmediate()}async function e6(e,t){return eG(e=(0,f.m9)(e),t)}function e4(e,t){return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t){if(!navigator)throw eA.create("only-available-in-window");return e.onMessageHandler=t,()=>{e.onMessageHandler=null}}(e=(0,f.m9)(e),t))}(0,u.Xd)(new d.wA("messaging",eQ,"PUBLIC")),(0,u.Xd)(new d.wA("messaging-internal",e0,"PRIVATE")),(0,u.KN)(eJ,eY),(0,u.KN)(eJ,eY,"esm2017")}}]);